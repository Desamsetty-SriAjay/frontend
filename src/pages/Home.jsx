...
//                 </h2>
//               </header>
//               <p className="prose prose-lg text-gray-200 mb-8 ">
...
const SkillCategory = ({ title, icons, colors, names, isOpen, onClick }) => (
  <div className="mb-6 overflow-hidden">
    ...
    <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4 mt-4 transition-all duration-500 ease-in-out overflow-hidden ${
      isOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
    }`}>
      {icons.map((Icon, idx) => (
        <div 
        ...
        >
          <Icon className={`text-4xl md:text-6xl mb-1 md:mb-2 ${colors[idx]}`} />
...
const Home = () => {
  ...
  return (
    <div className="space-y-12 md:space-y-20 py-6 md:py-12">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-gray-900 z-50 shadow-md">
        ...
        {isMenuOpen && (
          <div className="bg-gray-800 py-2 px-4">
            <a href="#skills" className="block py-2 text-white" onClick={() => setIsMenuOpen(false)}>Skills</a>
            <a href="#projects" className="block py-2 text-white" onClick={() => setIsMenuOpen(false)}>Projects</a>
            <a href="#details" className="block py-2 text-white" onClick={() => setIsMenuOpen(false)}>Contact</a>
          </div>
        )}
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col-reverse md:flex-row items-center gap-8">
            ...
            <div className="md:w-7/12">
              ...
              <div className="mt-6">
                <a href={Ajay_Resume} download="Sri_Ajay_Resume" className="block md:inline-block">
                  <button
      ...
      {/* Skills Section */}
      <section id="skills" className="py-12 md:py-16 bg-[#141516]">
        <div className="container mx-auto px-4">
      ...
      {/* Projects Section */}
      <section id="projects" className="py-12 md:py-20 bg-[#141516]">
        <div className="container mx-auto px-4">
          {/* Section Header */}
          <div className="text-center mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-xl bg-gray-900 border border-gray-800 hover:border-red-600 transition-all duration-500 hover:shadow-lg hover:shadow-red-900/20">
              <div className="h-40 md:h-48 bg-gradient-to-r from-gray-800 to-gray-700 flex items-center justify-center">
                <img src={TrendyCart} alt="TrendyCart" className="max-h-full max-w-full p-2" />
              </div>
              
              <div className="p-4 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-2">TrendyCart</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-red-400 rounded-full">React</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-blue-400 rounded-full">MongoDB</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-yellow-400 rounded-full">JavaScript</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-green-400 rounded-full">Node.js</span>
                </div>
                
                <div className="flex flex-wrap gap-4">
                  <a href="https://trendycart-frontend.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:text-red-300 font-medium flex items-center transition-colors text-sm md:text-base">
                    <svg className="w-4 h-4 md:w-5 md:h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                    </svg>
                    Live Demo
                  </a>
                  <a href="https://github.com/Desamsetty-SriAjay/TrendyCart--Fashion-E-Commerce-Website" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white font-medium flex items-center transition-colors text-sm md:text-base">
                    <svg className="w-4 h-4 md:w-5 md:h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                    </svg>
                    Source Code
            ...
            <div className="group relative overflow-hidden rounded-xl bg-gray-900 border border-gray-800 hover:border-red-600 transition-all duration-500 hover:shadow-lg hover:shadow-red-900/20">
              <div className="h-40 md:h-48 bg-gradient-to-r from-gray-800 to-gray-700 flex items-center justify-center">
                <div className="bg-gray-700 rounded-lg w-full h-full flex items-center justify-center">
                  <span className="text-gray-400 text-sm">Project Image</span>
                </div>
              </div>
              
              <div className="p-4 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-2">TaskMaster</h3>
                <p className="text-gray-400 mb-4 text-sm md:text-base">
                  Productivity application with real-time collaboration, task management, 
                  and deadline tracking features.
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-blue-500 rounded-full">React</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-purple-400 rounded-full">Firebase</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-green-400 rounded-full">Tailwind CSS</span>
                </div>
                
                <div className="flex flex-wrap gap-4">
                  <a href="#" className="text-red-400 hover:text-red-300 font-medium flex items-center transition-colors text-sm md:text-base">
                    <svg className="w-4 h-4 md:w-5 md:h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                    </svg>
                    Live Demo
                  </a>
                  <a href="#" className="text-gray-400 hover:text-white font-medium flex items-center transition-colors text-sm md:text-base">
                    <svg className="w-4 h-4 md:w-5 md:h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                    </svg>
                    Source Code
            ...
            <div className="group relative overflow-hidden rounded-xl bg-gray-900 border border-gray-800 hover:border-red-600 transition-all duration-500 hover:shadow-lg hover:shadow-red-900/20">
              ...
              <div className="p-4 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold text-white mb-2">WeatherWise</h3>
                <p className="text-gray-400 mb-4 text-sm md:text-base">
                  Weather forecasting application with location detection, 5-day forecasts, 
                  and severe weather alerts.
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-blue-400 rounded-full">React</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-yellow-400 rounded-full">JavaScript</span>
                  <span className="px-2 py-1 text-xs md:text-sm bg-gray-800 text-red-400 rounded-full">API Integration</span>
                </div>
          ...
          <div className="text-center mt-8 md:mt-12">
            <button className="px-6 py-2 md:px-8 md:py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-full transition-all duration-300 transform hover:scale-105">
              View All Projects
            </button>
          </div>
        </div>
      ...
      {/* Get In Touch */}
      <section id="details" className="py-12 md:py-16 bg-[#141516]">
        <div className="container mx-auto px-4 text-center">
